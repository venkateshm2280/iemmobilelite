...
class AccomDetails extends StatefulWidget {
  const AccomDetails({Key? key}) : super(key: key);

  @override
  State<AccomDetails> createState() => _AccomDetailsState();
}

class _AccomDetailsState extends State<AccomDetails> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: Scaffold(
          appBar: AppBar(
            title: Text('Details - Accomodation'),
            centerTitle: true,
          ),
